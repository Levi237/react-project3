        ...
        return (
            ...
            <section className="alertList" key={i}>
                ...
                <div className="title" onClick={this.toggle}>
                    ...
                    <button className="userListButton" onClick={this.props.deleteItem.bind(null, this.state.openList.id, this.props.currentUser.id)}>Remove from List Coming Soon</button>
                </div>
            </section>
        )
    })
