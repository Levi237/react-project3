...
<div className="navBox">
    ...
    { currentUser 
        ? <NavLink activeClassName="active" className="navBtn" to={routes.TRACKER} >TRACK</NavLink> 
        : <NavLink activeClassName="active" className="navBtn" to={routes.REGISTER} >JOIN</NavLink>
    }
    { currentUser &&
        <NavLink activeClassName="active" className="navBtn" to={routes.SEARCH}>SEARCH</NavLink>
    }
    { currentUser 
        ? <NavLink activeClassName="active" className="navBtn" to={routes.LOGOUT} onClick={logoutUser}>LOGOUT</NavLink> 
