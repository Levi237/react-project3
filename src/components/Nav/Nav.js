...
<div className="navBox">
    ...
    {
    currentUser ? <NavLink activeClassName="active" className="navBtn" to={routes.TRACKER} >TRACK</NavLink> : <NavLink activeClassName="active" className="navBtn" to={routes.REGISTER} >JOIN</NavLink>
    }
    {
