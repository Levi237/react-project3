    ...
    return (
      <div className="grid-container">
        ...
        <Switch>
          ...
          <Route exact path={routes.TRACK} render={() => currentUser && <OpenList handleSetMap={this.handleSetMap}  currentUser={currentUser} closureList={closureList}/>}  deleteItem={this.deleteItem}/>
